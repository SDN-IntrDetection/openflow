...
void OF_Switch::initialize(){
    ...
    //stats
    truePositive = registerSignal("truePositive");
    trueNegative = registerSignal("trueNegative");
    falsePositive = registerSignal("falsePositive");
    falseNegative = registerSignal("falseNegative");
...
void OF_Switch::processFrame(EthernetIIFrame *frame){
    ...
    if(dynamic_cast<IPv4Datagram_Base *>(frame->getEncapsulatedPacket()) != NULL){
        IPv4Datagram_Base *datagram = (IPv4Datagram_Base *)frame->getEncapsulatedPacket();

        match.OFB_IPV4_SRC = datagram->getSrcAddress();
        match.OFB_IPV4_DST = datagram->getDestAddress();
        EV << "IPV4 src .getInt() gives: " << match.OFB_IPV4_SRC.getInt() << '\n';

        }

    if(dynamic_cast<TCPSegment_Base *>(frame->getEncapsulatedPacket()->getEncapsulatedPacket()) != NULL){
        TCPSegment_Base *segment = (TCPSegment_Base *)frame->getEncapsulatedPacket()->getEncapsulatedPacket();

        match.OFB_SYN_FLAG = segment->getSynBit();
        match.OFB_ACK_FLAG = segment->getAckBit();
   ...
   if (lookup != NULL){
       //lookup successful
       flowTableHit++;
       if (lookup->getExpiresAt()<= simTime()){
          ...
          packetIn->setReason(OFPR_THRESHOLD_REACHED);
       ...
       if(outport == OFPP_CONTROLLER){
           ...
           EV << "IPV4 source .getInt() gives: " << match.OFB_IPV4_SRC.getInt() << '\n';
           if(hash !=0){
               emit(dpPingPacketHash,hash);
           }

/*           if ((((167772357 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772380) /*&& (match.OFB_IPV4_SRC.getInt() != 167772369)) || ((167772288 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772338) && (match.OFB_IPV4_SRC.getInt() != 167772335)) || (match.OFB_IPV4_SRC.getInt() == 167772347)) && (outport == OFPP_ANY)){ // True Positive
               emit(truePositive, simTime());
               EV << "True Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
           }

           if (!((( 167772357 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772380) && (match.OFB_IPV4_SRC.getInt() != 167772369)) || ((167772288 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772338) && (match.OFB_IPV4_SRC.getInt() != 167772335)) || (match.OFB_IPV4_SRC.getInt() == 167772347)) && (outport != OFPP_ANY)){ // True Negative
               emit(trueNegative,1);
               EV << "True Negative emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
           }

           if (!((( 167772357 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772380) && (match.OFB_IPV4_SRC.getInt() != 167772369)) || ((167772288 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772338) && (match.OFB_IPV4_SRC.getInt() != 167772335)) || (match.OFB_IPV4_SRC.getInt() == 167772347)) && (outport == OFPP_ANY)){ // False Positive
               emit(falsePositive,1);
               EV << "False Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
           }

           if (((( 167772357 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772380) && (match.OFB_IPV4_SRC.getInt() != 167772369)) || ((167772288 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772338) && (match.OFB_IPV4_SRC.getInt() != 167772335)) || (match.OFB_IPV4_SRC.getInt() == 167772347)) && (outport != OFPP_ANY)){ // False Negative
               emit(falseNegative,1);
               EV << "False Negative emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
           }
*/
           if(((167772309 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772330) && (match.OFB_IPV4_SRC.getInt() != 167772320)) || (match.OFB_IPV4_SRC.getInt() == 167772300)  || ((167772309 < match.OFB_IPV4_SRC.getInt()) && (match.OFB_IPV4_SRC.getInt() < 167772330) && (match.OFB_IPV4_SRC.getInt() != 167772330)) ){
               if(outport == OFPP_ANY){
                   emit(truePositive, simTime());
                   EV << "True Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
               } else{
                   emit(falseNegative,simTime());
                   EV << "False Negative emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
               }
           } else{
               if(outport == OFPP_ANY){
                   emit(falsePositive,simTime());
                   EV << "False Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
               } else{
                   emit(trueNegative,simTime());
                   EV << "True Negative emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
               }
           }
...
void OF_Switch::executePacketOutAction(ofp_action_header *action, EthernetIIFrame *frame, uint32_t inport){
    ...
    if(dynamic_cast<IPv4Datagram_Base *>(frame->getEncapsulatedPacket()) != NULL){
        ...
        IPv4Address source_adr = datagram->getSrcAddress();


/*       if ((((167772357 < source_adr.getInt()) && (source_adr.getInt() < 167772380) && (source_adr.getInt() != 167772369)) || ((167772288 < source_adr.getInt()) && (source_adr.getInt() < 167772338) && (source_adr.getInt() != 167772335)) || (source_adr.getInt() == 167772347)) && (outport == OFPP_ANY)){ // True Positive
           emit(truePositive,simTime());
           EV << "1True Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
       }

       if (!(((167772357 < source_adr.getInt()) && (source_adr.getInt() < 167772380) && (source_adr.getInt() != 167772369)) || ((167772288 < source_adr.getInt()) && (source_adr.getInt() < 167772338) && (source_adr.getInt() != 167772335)) || (source_adr.getInt() == 167772347)) && (outport != OFPP_ANY)){ // True Negative
           emit(trueNegative,1);
           EV << "1True Negative emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
       }

       if (!(((167772357 < source_adr.getInt()) && (source_adr.getInt() < 167772380) && (source_adr.getInt() != 167772369)) || ((167772288 < source_adr.getInt()) && (source_adr.getInt() < 167772338) && (source_adr.getInt() != 167772335)) || (source_adr.getInt() == 167772347)) && (outport == OFPP_ANY)){ // False Positive
           emit(falsePositive,1);
           EV << "1False Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
       }

       if ((((167772357 < source_adr.getInt()) && (source_adr.getInt() < 167772380) && (source_adr.getInt() != 167772369)) || ((167772288 < source_adr.getInt()) && (source_adr.getInt() < 167772338) && (source_adr.getInt() != 167772335)) || (source_adr.getInt() == 167772347)) && (outport != OFPP_ANY)){ // False Negative
           emit(falseNegative,1);
           EV << "1False Negative emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
       }

*/
        EV << "IPV4 source .getInt() gives: " << source_adr.getInt() << '\n';

       if(((167772309 < source_adr.getInt()) && (source_adr.getInt() < 167772330) && (source_adr.getInt() != 167772320)) || (source_adr.getInt() == 167772300) || ((167772309 < source_adr.getInt()) && (source_adr.getInt() < 167772330) && (source_adr.getInt() != 167772330))){
           if(outport == OFPP_ANY){
               emit(truePositive, simTime());
               EV << "1True Positive emitted!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1 " << '\n';
           } else{
