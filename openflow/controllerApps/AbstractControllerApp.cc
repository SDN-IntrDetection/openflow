...
//        headerFields.syn_flag = dynamic_cast<TCPSegment_Base *>(packet_in_msg->getEncapsulatedPacket())->getSynBit();

        IPv4Datagram_Base *ipDatagram = check_and_cast<IPv4Datagram_Base *>((dynamic_cast<EthernetIIFrame *>(packet_in_msg->getEncapsulatedPacket()))->getEncapsulatedPacket());
        headerFields.src_adr = ipDatagram->getSrcAddress();
        headerFields.dst_adr = ipDatagram->getDestAddress();

        TCPSegment_Base *tcpSegment = check_and_cast<TCPSegment_Base *>((dynamic_cast<EthernetIIFrame *>(packet_in_msg->getEncapsulatedPacket()))->getEncapsulatedPacket()->getEncapsulatedPacket());

        headerFields.syn_flag = tcpSegment->getSynBit();
        headerFields.ack_flag = tcpSegment->getAckBit();
        ...
        headerFields.syn_flag = packet_in_msg->getMatch().OFB_SYN_FLAG;
        headerFields.ack_flag = packet_in_msg->getMatch().OFB_ACK_FLAG;
        headerFields.src_adr = packet_in_msg->getMatch().OFB_IPV4_SRC;
        headerFields.dst_adr = packet_in_msg->getMatch().OFB_IPV4_DST;
    }
