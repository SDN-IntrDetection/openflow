...
// cplusplus {{
    ...
    inline std::ostream& operator<<(std::ostream& os, oxm_basic_match match)
    {
		...
		os << ", OFB_ARP_THA: " << match.OFB_ARP_THA << ", OFB_ARP_SPA: " << match.OFB_ARP_SPA << endl;
		os << ", OFB_ARP_TPA: " << match.OFB_ARP_TPA << ", OFB_SYN_FLAG: " << match.OFB_SYN_FLAG;
		os << ", OFB_ACK_FLAG: " << match.OFB_ACK_FLAG;
		os << ", OFB_IPV4_SRC:" << match.OFB_IPV4_SRC << ", OFB_IPV4_DST: " << match.OFB_IPV4_DST << endl;
		return os;
	}
// }}
